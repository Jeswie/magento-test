...
class MyModule_FirstModule_Block_Adminhtml_Contact_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getResourceModel('firstmodule/contact_collection');
    ...
    {
        $helper = Mage::helper('firstmodule');
